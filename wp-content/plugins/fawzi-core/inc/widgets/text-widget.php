...
class vt_text_widget extends WP_Widget {
  ...
  public function __construct() {
    parent::__construct(
      'vt-text-widget',
      VTHEME_NAME_P . __( ': Text Widget', 'fawzi' ),
      array(
        'classname'   => 'vt-text-widget',
        'description' => VTHEME_NAME_P . __( ' widget that displays contents.', 'fawzi' )
      )
    );
  }
...
add_action( 'widgets_init', create_function( '', 'register_widget( "vt_text_widget" );' ) );